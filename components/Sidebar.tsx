...
const NAV = [
  ...
  { href: '/reviews',   icon: FileText,        label: '리뷰 데이터' },
  { href: '/report',    icon: BarChart2,        label: '월간 리포트' },
  { href: '/tasks',     icon: CheckSquare,      label: '수행과제' },
  { href: '/analytics', icon: TrendingUp,       label: '분석 & 트렌드' },
  { href: '/rawdata',   icon: Database,        label: 'Raw Data' },
]
